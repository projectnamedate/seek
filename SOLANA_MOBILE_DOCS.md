...
Curated list of open-source Solana tools including:
- Wallet adapters (Anza, Solana Wallet Adapter)
- NFT tools (Bubblegum, Underdog SDK)
- Infrastructure (Lite RPC, Jito Relayer)
- Frameworks (Anchor, Umi, Kinobi)

## AI Toolkit
https://docs.solanamobile.com/developers/ai-toolkit

Claude Code skills for Solana Mobile development:
- install-wallet-ui-react-native skill
- LLM-ready docs at /llms.txt and /llms-full.txt

## dApp Store Submission
https://docs.solanamobile.com/dapp-publishing/submit-new-app

Requirements: Signed APK, ~0.2 SOL, KYC/KYB, ArDrive storage
