...
const tier1Missions: Omit<Mission, 'id' | 'tier' | 'difficulty'>[] = [
  ...
  { description: 'Find a deciduous tree (broad leaves, not pine/evergreen) with completely bare branches — no leaves at all', keywords: ['bare tree', 'deciduous', 'no leaves', 'leafless', 'bare branches'], location: 'outdoor' },
  ...
  { description: 'Find an outdoor cat wearing a visible collar with at least one tag attached', keywords: ['cat collar', 'cat tag', 'outdoor cat', 'collared cat'], location: 'outdoor' },
  ...
  { description: 'Find a sidewalk slab with a single crack running entirely across (full width, edge to edge visible)', keywords: ['sidewalk crack full width', 'crack across slab', 'edge to edge crack', 'split slab'], location: 'outdoor' },
  ...
  { description: 'Find a ceiling fan with a visible pull-chain hanging from its center', keywords: ['ceiling fan', 'pull chain', 'pull-chain fan', 'chain hanging'], location: 'indoor' },
...
const tier3Missions: Omit<Mission, 'id' | 'tier' | 'difficulty'>[] = [
  ...
  { description: 'Find a person playing chess at an outdoor public chess table or board', keywords: ['outdoor chess', 'public chess', 'chess board outdoor', 'park chess'], location: 'outdoor' },
