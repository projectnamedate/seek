...
export const RK = {
  ...
  bountySessionChallenge: (challengeId: string) => `seek:session:challenge:${challengeId}`,
  bountySessionChallengeUse: (challengeId: string) => `seek:session:challenge-used:${challengeId}`,
  bountySessionToken: (tokenHash: string) => `seek:session:token:${tokenHash}`,
